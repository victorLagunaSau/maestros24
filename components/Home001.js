        ...
        <div className="" id="home" style={{backgroundImage: "url('/assets/bgheader.jpg')",}}>
            <div className="grid grid-flow-row sm:grid-flow-col grid-cols-1 sm:grid-cols-2">
                <ScrollAnimationWrapper className="mt-20">
                    <motion.div className="flex flex-col items-end ml-auto w-full lg:w-9/12 p-4 my-6"
                                variants={scrollAnimation}>

                        <div className="text-3xl lg:text-3xl font-medium text-white-100">
                        ...
                        {/* Botón Videotutoriales centrado */}
                        <div className="flex flex-col items-center ml-auto p-4 w-full">
                            <div className="grid grid-flow-row sm:grid-cols-1 grid-cols-1 gap-2 mt-3 w-full">
                                <LinkScroll
                                    key="videotutoriales"
                                    activeClass="active"
                                    to="videotutoriales"
                                    ...
                                    smooth={true}
                                    duration={1000}
                                    onSetActive={() => setActiveLink("videotutoriales")}
                                    className="btn btn-outline py-2 px-5 sm:px-8 border-blue-400 text-blue-400 bg-white-500 hover:bg-blue-700 hover:text-blue-400 transition-all hover:shadow-blue-700 w-full"
                                >
                                    Videotutoriales
                                </LinkScroll>
                            </div>
                ...
                <ScrollAnimationWrapper style={{alignSelf: "flex-end"}}>
                    <motion.div variants={scrollAnimation} className="hidden lg:inline-block">
                        <Image
                            ...
                            height={300} // Mitad del tamaño original (370 / 2)
                            width={370}  // Mitad del tamaño original (400 / 2)
                        />
                    </motion.div>
                </ScrollAnimationWrapper>
            </div>
